...
<head>
  ...
  <!-- Bootstrap CSS Files -->
  <link href="<?= base_url('public/assets/bootstrap/animate.css/animate.min.css') ?>" rel="stylesheet">
  <link href="<?= base_url('public/assets/bootstrap/bootstrap/css/bootstrap.min.css') ?>" rel="stylesheet">
  <link href="<?= base_url('public/assets/bootstrap/bootstrap-icons/bootstrap-icons.css') ?>" rel="stylesheet">
  <link href="<?= base_url('public/assets/bootstrap/swiper/swiper-bundle.min.css') ?>" rel="stylesheet">
...
<body>
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<?= base_url('/property') ?>">Property</a>
          </li>
  ...
  <?= $this->renderSection('property_grid') ?>
  <?= $this->renderSection('blog') ?>
  <?= $this->renderSection('property_single') ?>
        ...
        <div class="col-md-12">
          <nav class="nav-footer">
            <ul class="list-inline">
              ...
              <li class="list-inline-item">
                <a href="<?= base_url('/property') ?>">Property</a>
              </li>
              <!-- <li class="list-inline-item">
  ...
  <!-- Bootstrap JS Files -->
  <script src="<?= base_url('public/assets/bootstrap/bootstrap/js/bootstrap.bundle.min.js') ?>"></script>

  <script src="<?= base_url('public/assets/bootstrap/swiper/swiper-bundle.min.js') ?>"></script>
